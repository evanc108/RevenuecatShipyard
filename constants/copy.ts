export const COPY = {
  ...
  pantry: {
    ...
    yourFood: {
      ...
      clearAll: 'Clear All',
      clearAllConfirm: 'Remove all pantry items?',
      categories: {
        produce: 'Produce',
        dairy: 'Dairy',
        meat: 'Meat & Seafood',
    ...
    generate: {
      button: 'Plan from Pantry',
      emptyPantryPrompt: 'Your pantry\'s empty - add some items to get started!',
      title: 'Generate Meal Plan',
      subtitle: 'We\'ll build a meal plan around what you already have',
      vibeLabel: 'What\'s the vibe?',
      vibePlaceholder: 'High protein? Date night? Comfort food?',
      cuisineLabel: 'Any cuisine in mind?',
      cuisinePlaceholder: 'Italian, Thai, Mexican...',
      usingItems: (count: number) =>
        `${count} ingredient${count === 1 ? '' : 's'} to work with`,
      submit: 'Make My Meal Plan',
      generating: 'Cooking up ideas...',
      error: 'Something went wrong - give it another try?',
    },
    review: {
      title: 'Your Meal Plan',
      subtitle: (count: number) => `${count} recipe${count === 1 ? '' : 's'} generated`,
    ...
    schedule: {
      ...
      daily: 'Daily for',
      days: 'days',
      thisWeek: 'This whole week',
      confirm: 'Add to Plan',
      adding: 'Adding...',
      success: 'Added to meal plan',
      addToGroceries: 'Add ingredients to grocery list',
    },
    groceries: {
      title: 'Grocery List',
      emptyTitle: 'Your grocery list is empty',
      emptySubtitle: 'Add ingredients from recipes or your meal plan',
      itemCount: (count: number) => `${count} item${count === 1 ? '' : 's'}`,
      clearAll: 'Clear List',
      clearAllConfirm: 'Remove all items from your grocery list?',
      clearAllSuccess: 'Grocery list cleared',
      addedToCart: 'Added to grocery list',
      addToCart: 'Add to Cart',
      added: 'Added!',
      pantryDeduction: (amount: number, unit: string) => `${amount} ${unit} in pantry`,
      ...
      save: 'Save',
      cancel: 'Cancel',
      openAmazon: 'Shop on Amazon Fresh',
      generatingLinks: 'Getting shopping links...',
