...
You MUST calculate and provide nutrition values (calories, protein_grams, carbs_grams, fat_grams) per serving based on the ingredients you extract. Use standard nutritional values:
